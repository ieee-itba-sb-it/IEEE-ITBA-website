...
@NgModule({
    declarations: [NavbarComponent, FooterComponent, LoadingSpinnerComponent, Error401Component,
        ...
        TeamCardComponent, EventCardShortComponent, StudentChapterComponent, PaginationComponent, EventTitleComponent, EventBannerComponent, EventContentCardComponent, EventFaqAccordionComponent, EventSectionComponent],
    imports: [
        routing,
        CommonModule,
