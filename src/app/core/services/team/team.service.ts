...
export class TeamService {
  ...
  private embTeam = {
    ...
    team: [
      ...
      new IEEEMember('Ivo Bajlec', 'https://i.ibb.co/pnn7ytj/Ivo-Bajlec.jpg', '', 'ibajlec@itba.edu.ar', 'NULL'),
      new IEEEMember('Felipe Olivera Rial', 'https://i.ibb.co/wwZS9pb/Felipe-Olivera-Rial.jpg', '', 'feolivera@itba.edu.ar', 'NULL'),
      ...
      new IEEEMember('Josefina Brau', 'https://i.ibb.co/N71cmRv/Josefina-Brau.jpg', '', 'jbrau@itba.edu.ar', 'NULL'),
      ...
      new IEEEMember('Juan Manuel Peirano', 'https://i.ibb.co/Fn0cXRn/Juan-Manuel-Peirano.jpg', '', 'jpeirano@itba.edu.ar', 'NULL'),
